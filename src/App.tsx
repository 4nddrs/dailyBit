...
function AuthForm() {
  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center bg-canvas-inset px-4 py-10">
...
function ThemeToggleButton() {
  ...
  return (
    <button
      className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-md border border-line bg-control text-fg-muted transition hover:bg-control-hover hover:text-fg"
      type="button"
      aria-label={label}
      title={label}
      onClick={toggleTheme}
